package in.arjsna.voicerecorder.audiovisualization;
...
public abstract class DbmHandler<TData> {
    ...
    public static class Factory {
         ...
         */
        public static VisualizerDbmHandler newVisualizerHandler(@NonNull Context context, @NonNull
         ...
         * @see SpeechRecognizer
         */
        public static SpeechRecognizerDbmHandler newSpeechRecognizerDbmHandler(@NonNull
            Context context, float minRmsDbValue, float maxRmsDbValue) {
